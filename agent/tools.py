...
@tool
def search_in_policy_documents(query: str) -> str:
    """Search in the company's policy documents for relevant information.

    Args:
        query: A question or search string from the user.
    Returns:
        A string containing the relevant information from the policy documents.
    """

    return service.search_in_documents(query)
    # return "Searching in policy documents for query: {query}... (This is a placeholder response. Implement the actual search logic.)"
